...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        setLayout(null); //because by default setLayout is border layout so we set null here.
        getContentPane().setBackground(Color.BLACK);
        setBounds(360, 140, 900, 400);
        ...
        l2.setFont(new Font("Monospace", Font.PLAIN,20));
        p2.add(l2);
        t1 = new JTextField();
    ...
    public void actionPerformed(ActionEvent ae){ 
        // for overradding method and action perform on button
        if(ae.getSource() == b1){
            try{
